...
public class MockMessageBuilder implements MessageBuilder {
    ...
    @Override
    public @NotNull MessageBuilder inline(
            @NotNull final byte[] content, @NotNull final String type, @NotNull final String cid) {
        return this;
    }
    ...
    @Override
    public @NotNull MessageBuilder attachment(
            @NotNull final byte[] content, @NotNull final String type, @NotNull final String filename) {
        return this;
    }
    ...
    @Override
    public @NotNull MessageBuilder inline(
            byte @NotNull [] content, @NotNull String type, @NotNull String cid, @Nullable Collection<Header> headers) {
        return null;
    }
}
