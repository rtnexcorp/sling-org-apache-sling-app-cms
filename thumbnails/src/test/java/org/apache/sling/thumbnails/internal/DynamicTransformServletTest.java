...
public class DynamicTransformServletTest {
    ...
    public void testPersist() throws IOException, ServletException {
        ...
        context.create()
                .resource(
                        "/content/slingfile.jpg", Collections.singletonMap(JcrConstants.JCR_PRIMARYTYPE, "sling:File"));
        ...
        slingFileProperties.put(
                JcrConstants.JCR_DATA,
                context.resourceResolver()
                        .getResource("/content/apache/sling-apache-org/index/apache.png")
    ...
    public void testMissingResource() throws IOException, ServletException {
        ...
        context.request()
                .addRequestParameter("resource", "/content/apache/sling-apache-org/index/wow-look-at-this-file.png");
        context.request().addRequestParameter("format", "png");
        context.request()
                .setContent(
                        "[{\"handlerType\":\"sling/thumbnails/transformers/crop\",\"properties\":{\"position\":\"CENTER\",\"width\":1000,\"height\":1000}}]"
