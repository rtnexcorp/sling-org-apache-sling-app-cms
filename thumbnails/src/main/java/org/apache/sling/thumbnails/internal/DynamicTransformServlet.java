...
@Component(
        ...
        property = {"sling.servlet.methods=POST", "sling.servlet.paths=/bin/sling/thumbnails/transform"})
public class DynamicTransformServlet extends SlingAllMethodsServlet {
    ...
    protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response)
        ...
        try {
            ...
            OutputFileFormat format = OutputFileFormat.forValue(
                    Optional.ofNullable(request.getParameter("format")).orElse("jpeg"));
    ...
    private List<TransformationHandlerConfigImpl> parsePostBody(SlingHttpServletRequest request) throws IOException {
        ...
        try {
            return objectMapper.readValue(
                    request.getReader(), new TypeReference<List<TransformationHandlerConfigImpl>>() {});
    ...
    private ByteArrayOutputStream transform(
            Resource resource, SlingHttpServletResponse response, String format, Transformation transformation)
            throws IOException {
