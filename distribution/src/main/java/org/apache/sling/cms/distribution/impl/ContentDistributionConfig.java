...
public @interface ContentDistributionConfig {
    ...
    @AttributeDefinition(
        name = "Enabled",
        description = "Enable content distribution"
    )
    ...
    @AttributeDefinition(
        ...
        description = "Username for authentication to publisher"
    )
    String publisherUsername() default "admin";

    @AttributeDefinition(
        name = "Publisher Password",
        description = "Password for authentication to publisher"
    )
    ...
    @AttributeDefinition(
        name = "Allowed Roots",
        description = "Content roots that can be distributed"
    )
    ...
    @AttributeDefinition(
        name = "Async Distribution",
        description = "Perform distribution asynchronously"
    )
