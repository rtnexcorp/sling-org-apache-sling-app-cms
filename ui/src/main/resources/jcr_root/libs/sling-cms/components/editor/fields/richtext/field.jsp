...
<div class="rte">
    ...
    <textarea class="rte-editor textarea" id="${sling:encode(properties.name,'HTML_ATTR')}" name="${sling:encode(not empty fieldName ? fieldName : properties.name,'HTML_ATTR')}" ${required} ${disabled}>${value}</textarea>
</div>