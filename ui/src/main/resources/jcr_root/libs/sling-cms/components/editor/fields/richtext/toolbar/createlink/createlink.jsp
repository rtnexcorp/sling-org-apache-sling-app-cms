...
<div data-tiptap-dialog="createLink" style="display: none;">
    <div class="has-padding-1 has-background-white-ter rte-form">
        <p><fmt:message key="Link" /></p>
        <div class="field has-addons">
            <div class="control is-expanded">
                <input class="input pathfield is-small" data-tiptap-dialog-field="href" data-type="nt:hierarchyNode" data-base="/content" autocomplete="off" />
            </div>
            <div class="control">
       ...
       <div class="field">
            <select class="select is-small" data-tiptap-dialog-field="target">
