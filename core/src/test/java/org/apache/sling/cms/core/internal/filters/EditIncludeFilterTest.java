...
public class EditIncludeFilterTest {
    ...
    public void testComponent() throws IOException, ServletException {
        ...
        assertEquals(
                "<div class=\"sling-cms-component\" data-reload=\"false\" data-component=\"/libs/sling-cms/components/general/richtext\" data-sling-cms-title=\"Rich Text Editor\" data-sling-cms-resource-path=\"/content/apache/sling-apache-org/index/jcr:content/menu/richtext\" data-sling-cms-resource-type=\"sling-cms/components/general/richtext\" data-sling-cms-edit=\"/libs/sling-cms/components/general/richtext/edit\" data-sling-cms-resource-name=\"richtext\">    <div class=\"sling-cms-editor\" draggable=\"false\">        <div class=\"level has-background-light\">            <div class=\"level-left\">                <div class=\"field has-addons\"><div class=\"control\">    <a href=\"/cms/editor/edit.html/content/apache/sling-apache-org/index/jcr:content/menu/richtext?editor=/libs/sling-cms/components/general/richtext/edit\" class=\"level-item button is-small has-text-black-ter action-button\"  title=\"Edit Rich Text Editor\">        <span class=\"icon\">            <span class=\"jam jam-pencil-f\">                <span class=\"is-sr-only\">Edit Rich Text Editor</span>            </span>        </span>    </a></div><div class=\"control\">    <a href=\"/cms/editor/delete.html/content/apache/sling-apache-org/index/jcr:content/menu/richtext\" class=\"level-item button is-small has-text-black-ter action-button\" title=\"Delete Component\">        <span class=\"icon\">            <span class=\"jam jam-trash\">                <span class=\"is-sr-only\">Delete Rich Text Editor</span>            </span>        </span>    </a></div>            </div>          </div>        <div class=\"level-right\">            <div class=\"level-item has-text-black-ter\">Rich Text Editor</div>        </div>    </div></div></div>",
                context.response().getOutputAsString().replaceAll("[\\n\\r]", ""));
    }
