...
public class FileMetadataExtractorImplTest {
    ...
    public void testFormatKey() throws IOException, RepositoryException {
        ...
        String[] keys = new String[] {
            ...
            "GPS:GPS Longitude",
            "Exif SubIFD:Time Zone Original",
        ...
        String[] expected = new String[] {
            "GPS:GPSImgDirection",
            "ExifSubIFD:SubjectDistanceRange",
            "CompressionType",
            "NumberofComponents",
            "Component2",
            "Component1",
            "ExifIFD0:XResolution",
            "tiff:ResolutionUnit",
            "ExifSubIFD:SceneType",
            "ExifSubIFD:ExposureMode",
            "tiff:Make",
            "ExifSubIFD:Sharpness",
            "ExifSubIFD:CustomRendered",
            "Component3",
            "ExifSubIFD:ComponentsConfiguration",
            "ExifSubIFD:MeteringMode",
            "ExifSubIFD:WhiteBalanceMode",
            "tiff:BitsPerSample",
            "ExifSubIFD:Sub-SecTimeOriginal",
            "meta:creation-date",
            "Creation-Date",
            "tiff:Orientation",
            "tiff:Software",
            "geo:long",
            "ExifSubIFD:DigitalZoomRatio",
            "tiff:YResolution",
            "YResolution",
            "ExifSubIFD:Flash",
            ...
            "exif:ExposureTime",
            "FileSize",
            "ExifSubIFD:ExifVersion",
            "GPS:GPSImgDirectionRef",
            "ExifSubIFD:FocalLength",
            "ExifIFD0:ResolutionUnit",
            "ExifSubIFD:LensModel",
            "ExifSubIFD:Date-TimeOriginal",
            "ExifSubIFD:Sub-SecTimeDigitized",
            "ResolutionUnits",
            "FileModifiedDate",
            "ExifSubIFD:SensingMethod",
            "ImageHeight",
            "ThumbnailWidthPixels",
            "GPS:GPSLongitude",
            "ExifSubIFD:TimeZoneOriginal",
            "GPS:GPSLongitudeRef",
            "tiff:Model",
            "ExifSubIFD:BrightnessValue",
            "exif:IsoSpeedRatings",
            "ExifSubIFD:ExposureProgram",
            "ExifIFD0:Make",
            "GPS:GPSAltitudeRef",
            "ExifSubIFD:ApertureValue",
            "ExifSubIFD:Date-TimeDigitized",
            "tiff:ImageWidth",
            "GPS:GPSAltitude",
            "ExifIFD0:YResolution",
            "date",
            "ExifSubIFD:ISOSpeedRatings",
            "NumberofTables",
            "ExifSubIFD:TimeZoneDigitized",
            "ExifSubIFD:ExifImageWidth",
            "ExifSubIFD:Contrast",
            "XResolution",
            "ExifSubIFD:ExposureBiasValue",
            "ExifSubIFD:Saturation",
            "modified",
            "exif:FNumber",
            "ExifSubIFD:ShutterSpeedValue",
            "ExifIFD0:Orientation",
            "ExifSubIFD:F-Number",
            "exif:FocalLength",
            "ExifIFD0:Software",
            "ExifIFD0:Date-Time",
            "ExifSubIFD:SceneCaptureType",
            "ExifSubIFD:TimeZone",
            "geo:lat",
            "DataPrecision",
            "tiff:ImageLength",
            ...
            "ExifSubIFD:FocalLength35",
            "ExifSubIFD:ExposureTime",
            "meta:save-date",
            "FileName",
            "GPS:GPSLatitudeRef",
            "Content-Type",
            ...
            "ExifSubIFD:FlashPixVersion",
            "ExifSubIFD:ExifImageHeight",
            "ImageWidth",
            "GPS:GPSLatitude",
            "ExifSubIFD:LensMake",
            "GPS:GPSDateStamp"
    ...
    public void willRegisterNamespace() throws RepositoryException {
        ...
        Iterator<String> keys = Stream.of(
