...
@ObjectClassDefinition(
        name = "%pathsuggestionservlet.name",
        description = "%pathsuggestionservlet.description",
        localization = "OSGI-INF/l10n/bundle")
public @interface PathSuggestionServletConfig {

    @AttributeDefinition(
            name = "%pathsuggestionservlet.typeFilters.name",
            description = "%pathsuggestionservlet.typeFilters.description")
    String[] typeFilters() default {
        "page=sling:Page,nt:folder,sling:Site",
        "file=nt:file,nt:folder,sling:Site",
        "folder=nt:folder,sling:Site",
        "taxonomy=nt:folder,sling:Taxonomy",
        "config=nt:folder,sling:Config",
        "content=nt:hierarchyNode",
        "all=nt:base"
    };
}
