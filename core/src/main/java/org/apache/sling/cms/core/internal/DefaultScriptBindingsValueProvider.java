...
public class DefaultScriptBindingsValueProvider implements BindingsValuesProvider {
    ...
    public static final String PN_CURRENT_PAGE_EVALUATED =
            "org.apache.sling.cms.core.internal.DefaultScriptBindingsValueProvider_" + PN_CURRENT_PAGE + "_evaluated";
        ...
        bindings.put("componentConfiguration", new LazyBindings.Supplier() {
            ...
            public Object get() {
                return Optional.ofNullable(resource.adaptTo(ComponentConfiguration.class))
                        .map(ComponentConfiguration::getProperties)
                        .orElse(null);
            }
        });
