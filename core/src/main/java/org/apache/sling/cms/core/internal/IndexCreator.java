...
public class IndexCreator implements RepositoryInitializer {
    ...
    private void ensureSlingComponentIndex(NodeBuilder indexRoot) {
        ...
        indexRule
                .property("componentType", "componentType", false)
                .propertyIndex()
                .notNullCheckEnabled();
        indexRule
                ...
                .ordered();
        indexRule
                .property(PN_NODE_NAME, VAL_NODE_NAME, false)
                .analyzed()
                .propertyIndex()
                .ordered();

        indexRule
                .property("jcrLastModifiedBy", "jcr:content/jcr:lastModifiedBy", false)
                .propertyIndex();
    }
    ...
    private void ensureSlingEventJobIndex(NodeBuilder indexRoot) {
        ...
        indexRule
                .property("eventJobTopic", "event.job.topic", false)
                .propertyIndex()
                .analyzed();
        indexRule
                .property("slingeventCreated", "slingevent:created", false)
                .propertyIndex()
                .ordered()
                .type("Date");
        indexRule.property("slingeventId", "slingevent:eventId", false).propertyIndex();
        indexRule
                .property("slingeventFinishedState", "slingevent:finishedState", false)
                .nullCheckEnabled()
                .propertyIndex();
        indexRule
                .property("finishedDate", "slingevent:finishedDate", false)
                .propertyIndex()
                .ordered()
                .type("Date");
    }
    ...
    private void ensureSlingPageIndex(NodeBuilder indexRoot) {
        ...
        IndexDefinitionBuilder builder = new IndexDefinitionBuilder(index, true);
        builder.aggregateRule(
                CMSConstants.NT_PAGE,
                JCR_CONTENT_PROPERTIES,
                "jcr:content/*/*",
                "jcr:content/*/*/*",
                "jcr:content/*/*/*/*");
        builder.async(IndexConstants.ASYNC_PROPERTY_NAME, IndexConstants.INDEXING_MODE_NRT);
    ...
    private void ensureCommonSlingProperties(IndexRule indexRule) {
        indexRule
                .property(PN_JCR_TITLE, "jcr:content/jcr:title", false)
                .analyzed()
                .propertyIndex()
                .boost(2)
                .ordered();
        indexRule
                ...
                .ordered();
        indexRule
                .property("jcrDescription", "jcr:content/jcr:description", false)
                .analyzed()
                .propertyIndex();
        indexRule
                .property("jcrLastModified", "jcr:content/jcr:lastModified", false)
                .propertyIndex()
                .ordered()
                .type("Date");
        indexRule
                ...
                .propertyIndex();
        indexRule
                .property("slingPublished", "jcr:content/sling:published", false)
                .propertyIndex()
                .nullCheckEnabled()
                .type("Boolean");
        indexRule
                .property("slingTaxonomy", "jcr:content/sling:taxonomy", false)
                .propertyIndex()
                .analyzed();
        indexRule
                .property("allProperties", "jcr:content/.*", true)
                .propertyIndex()
                .analyzed();
    }
